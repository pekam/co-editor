...
var leaf_1 = __webpack_require__(17);
...
var _emitter3 = __webpack_require__(12);
...
var _shadowSelectionPolyfill = __webpack_require__(32);
...
var _op = __webpack_require__(18);
...
var Selection = function () {
  function Selection(scroll, emitter) {
    ...
    this.handleDragging();
    if (!_shadowSelectionPolyfill.usePolyfill) {
    ...
    value: function setNativeRange(startNode, startOffset) {
      ...
      if (startNode != null) {
        ...
        if (native == null || force || startNode !== native.startContainer || startOffset !== native.startOffset || endNode !== native.endContainer || endOffset !== native.endOffset) {
          ...
          (0, _shadowSelectionPolyfill.addRange)(this.rootDocument, selection, range);
        }
      } else {
...
var usePolyfill = exports.usePolyfill = !(hasSelection || useDocument);
...
function addRange(root, selection, range) {
